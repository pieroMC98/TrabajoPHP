...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-01-2020 a las 10:56:20
...
('Terminator: Dark Fate', 'Acción', '2019-08-31', 128, 'En 1998, tres años después de anular la amenaza de Skynet, Sarah y John Connor viven una vida tranquila después de eliminar a varios Terminators que Skynet había enviado a través del tiempo antes de ser borrada de la existencia. Sin saberlo, un Terminator T-800 los localiza en Livingston, Guatemala, atacándolos sorpresivamente en un restaurante en la playa y asesina brutalmente a John Connor antes de desaparecer, dejando a Sarah totalmente devastada.', 'img/terminator.jpg', 'EEUU', 'Junkie XL', 'Paramount Pictures');
